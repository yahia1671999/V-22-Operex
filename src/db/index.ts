    ...
    penalties: {
      createSql: `
        CREATE TABLE IF NOT EXISTS penalties (
          ...
          grievance_window_days INTEGER DEFAULT 7,
          visibility_duration_days INTEGER DEFAULT 30,
          grievance_start_date TEXT,
          grievance_deadline_date TEXT,
          visibility_end_date TEXT,
