...
import { MonthlyPayCardModal } from '../payroll/MonthlyPayCardModal';
...
export const Transactions: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Payslip Modal (Monthly Pay Card) */}
      <AnimatePresence>
        {selectedPayCard && (
          <MonthlyPayCardModal
            isOpen={!!selectedPayCard}
            onClose={() => setSelectedPayCard(null)}
            payCard={selectedPayCard}
            employee={employees.find(e => e.id === selectedPayCard.employeeId) || null}
            onOpenAttendanceDetails={handleOpenAttendanceDetails}
            onSyncApproved={handleSyncApproved}
            isSyncingApproved={isSyncingApproved}
            onOpenDeductionsBreakdown={() => setShowDeductionsBreakdown(true)}
          />
        )}
      </AnimatePresence>
